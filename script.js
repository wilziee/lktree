...
function initIntroSplash() {
    ...
    if (!introScreen || !introVideo || !skipBtn) return;

    // Memastikan video berputar otomatis (Fallback handler)
    introVideo.play().catch(error => {
        console.log("Autoplay didukung/diblokir oleh kebijakan browser:", error);
