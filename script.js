...
function initIntroSplash() {
    ...
    // Fungsi untuk memulai media saat diklik/disentuh
    const triggerPlay = (e) => {
        if (e) e.preventDefault(); // Mencegah bug double-tap di HP
        
        // Matikan fungsi klik di overlay agar tidak mengganggu web di bawahnya
        startOverlay.style.pointerEvents = 'none'; 
        startOverlay.style.opacity = '0';
        
        setTimeout(() => { startOverlay.style.display = 'none'; }, 500);

        // Putar audio dan video secara bersamaan (Murni tanpa sinkronisasi JS yang bikin lag)
        introVideo.play().catch(err => console.log("Video error:", err));
        introAudio.play().catch(err => console.log("Audio error:", err));
    ...
    // Terapkan deteksi click (PC) DAN touchstart (HP)
    ...
    const executeTransition = () => {
        ...
        setTimeout(() => {
            ...
            // Aktifkan kembali scroll & klik pada website utama
