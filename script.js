...
// ==========================================
// 9. Live Digital Clock, Date & Location
// ==========================================
let userLocation = "桃 Indonesia"; // Fallback awal
...
// =========================================
// 10. INTRO VIDEO SYSTEM (WITH SKIP BUTTON)
// =========================================
...
// Cek kalau video ada, baru jalanin event listener-nya
if (introVideo) {
    introVideo.addEventListener('timeupdate', () => {
        if (introVideo.currentTime >= 4) {
